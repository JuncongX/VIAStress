...
if __name__ == '__main__':
    ...
    for fold in range(args.k):
        ...
        lda = LDA()
        # lda.fit(np.concatenate((features_train, features_valid)),
        #         np.concatenate((labels_train, labels_valid)))
        lda.fit(features_train, labels_train)
        res = lda.predict(features_test)
        ...
        joblib.dump(lda, 'save/LDA_{0}{1}_{2}_{3}.pkl'.format(
            args.dataset_name,
