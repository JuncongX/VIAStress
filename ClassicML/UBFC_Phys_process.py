...
def cut_signal(dir_, ppg_signal, eda_signal, label, save_datas):
    ...
    eda_signal = nk.eda_clean(eda_signal, eda_sample_rate)
...
if __name__ == '__main__':
    havent_done = ['s1', 's2', 's3', 's4', 's5', 's6', 's7', 's8', 's9', 's10', 's11', 's13', 's14', 's15',
                   ...
                   's44', 's45', 's46', 's48', 's49', 's50', 's51', 's52', 's53', 's54', 's55', 's56', 's12', 's17',
                   's47']
    save_datas = []
    ...
    np.save("UBFC_Phys_CLM_clip{0}s.npy".format(clip_len), save_datas)
