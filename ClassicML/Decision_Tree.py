...
def DT():
    return Pipeline([
        ...
        ('DT', tree.DecisionTreeClassifier(criterion='entropy', min_samples_split=20, random_state=SEED))
    ])
...
if __name__ == '__main__':
    ...
    for fold in range(args.k):
        ...
        joblib.dump(dt, 'save/Decision_Tree_{0}{1}_{2}_{3}.pkl'.format(
            args.dataset_name,
