...
def RF():
    return Pipeline([
        ...
        ('RF', RandomForestClassifier(criterion='entropy', min_samples_split=20, n_estimators=100, random_state=SEED))
    ])
...
if __name__ == '__main__':
    ...
    for fold in range(args.k):
        ...
        joblib.dump(rf, 'save/Random_Forest_{0}{1}_{2}_{3}.pkl'.format(
            args.dataset_name,
