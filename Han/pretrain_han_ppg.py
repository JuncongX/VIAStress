# nohup python -u pretrain_han_ppg.py > Han_PPG_w.out &
# nohup python -u pretrain_han_ppg.py --dataset_name ubfc_phys --k 7 --ubfc_phys_task 2 > Han_PPG_u2.out &
# nohup python -u pretrain_han_ppg.py --dataset_name ubfc_phys --k 7 --ubfc_phys_task 3 > Han_PPG_u3.out &
# nohup python -u pretrain_han_ppg.py --dataset_name can_stress --k 5 > Han_PPG_CS.out &
# nohup python -u pretrain_han_ppg.py --dataset_name verbio --k 5 > Han_PPG_VB.out &
...
if __name__ == '__main__':
    ...
    for fold in range(args.k):
        ...
        model = model_conv1d_autoencoder(1, modality="ppg")
        ...
        for epoch in range(args.epoch):
            ...
            if valid_loss <= best_ever:
                ...
                torch.save(model.state_dict(),
                           os.path.join(args.save_path, 'Pre_Han_PPG_{0}_{1}_{2}{3}.pth'.format(
                               args.dataset_name,
                               args.y_dim,
