...
if __name__ == "__main__":
    ...
    for fold in range(args.k):
        ...
        network = WholeFish(args.x_dim, args.h_dim, args.y_dim)
        network.load_state_dict(torch.load(os.path.join(args.save_path,
        ...
        acc, f1, recall, precision = f1_accuracy(network, test_loader, args.y_dim, device)
        print(
