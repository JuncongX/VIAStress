# nohup python -u train_bv.py --y_dim 2 > BV_2.out &
# nohup python -u train_bv.py --y_dim 3 > BV_3.out &
# nohup python -u train_bv.py --y_dim 2 --dataset_name ubfc_phys --ubfc_phys_task 2 --k 7 > BV_2_UP2.out &
# nohup python -u train_bv.py --y_dim 2 --dataset_name ubfc_phys --ubfc_phys_task 3 --k 7 > BV_2_UP3.out &
# nohup python -u train_bv.py --y_dim 2 --dataset_name can_stress > BV_2_CS.out &
# nohup python -u train_bv.py --y_dim 2 --dataset_name verbio --k 5 --epoch 150 > BV_2_VB.out &
import numpy as np
import os
