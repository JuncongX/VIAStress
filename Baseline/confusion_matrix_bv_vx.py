# python confusion_matrix_bv_vx.py --dataset_name wesad --k 5 --vx 1 --y_dim 2
# python confusion_matrix_bv_vx.py --dataset_name ubfc_phys --k 7 --y_dim 2 --vx 1 --ubfc_phys_task 2
