# python perform_on_lq_bv.py --model_name wesad --k 5 --y_dim 2
# python perform_on_lq_bv.py --model_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 2
# python perform_on_lq_bv.py --model_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 3
# python perform_on_lq_bv.py --model_name verbio --k 6 --y_dim 2
