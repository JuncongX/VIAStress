# nohup python -u train_bv_v3.py --y_dim 2 > BV_v3_2.out &
# nohup python -u train_bv_v3.py --y_dim 3 > BV_v3_3.out &
# nohup python -u train_bv_v3.py --y_dim 2 --dataset_name ubfc_phys --ubfc_phys_task 2 --k 7 > BV_v3_2_UP2.out &
# nohup python -u train_bv_v3.py --y_dim 2 --dataset_name ubfc_phys --ubfc_phys_task 3 --k 7 > BV_v3_2_UP3.out &
# nohup python -u train_bv_v3.py --y_dim 3 --dataset_name ubfc_phys --k 7 > BV_v3_3_UP.out &
import numpy as np
import os
