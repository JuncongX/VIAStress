# python confusion_matrix_bv.py --dataset_name wesad --k 5 --y_dim 2
# python confusion_matrix_bv.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 2
# python confusion_matrix_bv.py --dataset_name can_stress --k 5 --y_dim 2
# python confusion_matrix_bv.py --dataset_name verbio --k 5 --y_dim 2
...
def f1_score_from_confusion_matrix(cm, num_classes):
    ...
    return accuracy, f1_macro, np.mean(recall), np.mean(precision)
