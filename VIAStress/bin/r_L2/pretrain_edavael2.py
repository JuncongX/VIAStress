# nohup python -u pretrain_edavael2.py > PREVAEAD_EDAl2_w.out &
# nohup python -u pretrain_edavael2.py --dataset_name ubfc_phys --k 7 --ubfc_phys_task 2 --epoch 250 > PREVAEAD_EDAl2_u2.out &
# nohup python -u pretrain_edavael2.py --dataset_name ubfc_phys --k 7 --ubfc_phys_task 3 > PREVAEAD_EDAl2_u3.out &
...
from VIAStress_wo_MMDG.model import EDAEncoder, EDADecoder
...
class Loss(nn.Module):
    def __init__(self, total_steps=100, kl_max=0.1):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default="./checkpoints_edal2")
    ...
    for fold in range(args.k):
        ...
        for epoch in range(args.epoch):
            ...
            if valid_person >= best_pc and epoch > 10:
