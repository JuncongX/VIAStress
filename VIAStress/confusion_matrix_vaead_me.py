# python confusion_matrix_vaead_ab.py --dataset_name wesad --k 5 --y_dim 2
# python confusion_matrix_vaead_ab.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 2
# python confusion_matrix_vaead_ab.py --dataset_name verbio --k 6 --y_dim 2
...
if __name__ == "__main__":
    ...
    for fold in range(args.k):
        ...
        for i, test_p_one in enumerate(test_p):
            ...
            cm = f1_accuracy(model, test_loader, args.y_dim, device)
            if confusion_mats is None:
                confusion_mats = cm
            else:
                confusion_mats += cm
        acc, f1, recall, precision = f1_score_from_confusion_matrix(confusion_mats, args.y_dim)
        print(
