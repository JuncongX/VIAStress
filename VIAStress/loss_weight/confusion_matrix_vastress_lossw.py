# python confusion_matrix_vastress_lossw.py --dataset_name wesad --k 5 --sc_w 0.1 --dl_w 0.1 --ct_w 0.1 --y_dim 2
# python confusion_matrix_vastress_lossw.py --dataset_name ubfc_phys --k 7 --y_dim 2 --sc_w 0.1 --dl_w 0.1 --ct_w 0.1  --ubfc_phys_task 2
