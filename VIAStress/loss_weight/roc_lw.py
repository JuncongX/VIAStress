# python roc_lw.py --dataset_name wesad --k 5 --y_dim 2 --sc_w 0.2 --dl_w 0.1 --ct_w 0.1
# python roc_lw.py --dataset_name ubfc_phys --sc_w 0.1 --dl_w 0.1 --ct_w 0.05 --k 7 --y_dim 2 --ubfc_phys_task 3
# python roc_lw.py --dataset_name verbio --k 6 --y_dim 2 --sc_w 0.1 --dl_w 0.1 --ct_w 0.05
...
def auc_score(network, loader, num_classes, device):
    ...
    with torch.no_grad():
        for labels, ppg, scr, scl, eda, peak in loader:
            ...
            eda = eda.to(device)
            out = network(ppg, eda)
            logits = out[0]  # (batch_size, num_classes)
