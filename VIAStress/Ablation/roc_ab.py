# python roc_ab.py --dataset_name wesad --k 5 --ab wo_Ldl --y_dim 2
# python roc_ab.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ab wo_dec --ubfc_phys_task 2
# python roc_ab.py --dataset_name verbio --k 6 --y_dim 2 --ab wo_Ldl
