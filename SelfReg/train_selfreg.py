# nohup python -u train_selfreg.py --y_dim 2 > SelfReg_2.out &
# nohup python -u train_selfreg.py --y_dim 3 > SelfReg_3.out &
# nohup python -u train_selfreg.py --dataset_name ubfc_phys --ubfc_phys_task 2 --y_dim 2 --k 7 > SelfReg_2_UP2.out &
# nohup python -u train_selfreg.py --dataset_name ubfc_phys --ubfc_phys_task 3 --y_dim 2 --k 7 > SelfReg_2_UP3.out &
import numpy as np
import os
...
from SelfReg.algorithms import SelfReg
...
def train(args, algorithm, data_loader):
    algorithm.train()
    train_loss, train_cm = 0.0, None
    ...
    for j, data in enumerate(data_loader):
        ...
        loss, cm = algorithm.update(ppg, eda, labels)
...
def valid(args, algorithm, data_loader):
    algorithm.eval()
    ...
    for j, data in enumerate(data_loader):
        ...
        pred_logits = algorithm.predict(ppg, eda)
    ...
    for fold in range(args.k):
        ...
        for epoch in range(args.epoch):
            ...
            for i, train_p_one in enumerate(train_p):
                ...
                train_loss, train_cm = train(args, algorithm, train_loader)
            ...
            print(
                "Epoch: {}, Avg_train_loss: {}, Avg_train_f1: {}, Avg_valid_loss: {}, Avg_valid_acc: {}%, Avg_valid_f1: {}".format(
                    epoch, epoch_train_loss, epoch_train_f1, epoch_valid_loss, epoch_valid_acc,
                    epoch_valid_f1))
            ...
            if epoch_valid_f1 >= bestf1_ever:
                ...
                torch.save(algorithm.state_dict(), os.path.join(args.save_path,
                                                                   'SelfReg_{0}_{1}_{2}{3}.pth'.format(
                                                                       args.dataset_name,
                                                                       args.y_dim,
