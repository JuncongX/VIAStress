# python roc_cross.py --model_name wesad --dataset_name ubfc_phys --k 5 --y_dim 2 --ubfc_phys_task 2 --n_bcsa 3
# python roc_cross.py --model_name wesad --dataset_name ubfc_phys --k 5 --y_dim 2 --ubfc_phys_task 3 --n_bcsa 3
# python roc_cross.py --model_name ubfc_phys --dataset_name wesad --k 7 --y_dim 2 --ubfc_phys_task 2 --n_bcsa 3
# python roc_cross.py --model_name ubfc_phys --dataset_name wesad --k 7 --y_dim 2 --ubfc_phys_task 3 --n_bcsa 4
# python roc_cross.py --model_name wesad --dataset_name verbio --k 5 --y_dim 2 --n_bcsa 3
# python roc_cross.py --model_name ubfc_phys --dataset_name verbio --k 7 --y_dim 2 --ubfc_phys_task 2 --n_bcsa 3
# python roc_cross.py --model_name ubfc_phys --dataset_name verbio --k 7 --y_dim 2 --ubfc_phys_task 3 --n_bcsa 4
# python roc_cross.py --model_name verbio --dataset_name wesad --k 6 --y_dim 2 --n_bcsa 3
# python roc_cross.py --model_name verbio --dataset_name ubfc_phys --k 6 --y_dim 2 --n_bcsa 3 --ubfc_phys_task 2
# python roc_cross.py --model_name verbio --dataset_name ubfc_phys --k 6 --y_dim 2 --n_bcsa 3 --ubfc_phys_task 3
...
from AUC.roc_me import auc_score, calculate_macro_auc
...
if __name__ == "__main__":
    ...
    from BCSA.bcsa import DAFMPPSR
