# python roc.py --dataset_name wesad --k 5 --y_dim 2 --n_bcsa 3
# python roc.py --dataset_name wesad --k 5 --y_dim 3 --n_bcsa 2
# python roc.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 2 --n_bcsa 3
# python roc.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 3 --n_bcsa 4
# python roc.py --dataset_name can_stress --k 5 --y_dim 2 --n_bcsa 3
# python roc.py --dataset_name verbio --k 5 --y_dim 2 --n_bcsa 3
