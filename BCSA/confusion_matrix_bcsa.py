# python confusion_matrix_bcsa.py --dataset_name wesad --k 5 --y_dim 2 --n_bcsa 3
# python confusion_matrix_bcsa.py --dataset_name wesad --k 5 --y_dim 3 --n_bcsa 2
# python confusion_matrix_bcsa.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 2 --n_bcsa 3
# python confusion_matrix_bcsa.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 3 --n_bcsa 4
# python confusion_matrix_bcsa.py --dataset_name can_stress --k 5 --y_dim 2 --n_bcsa 3
# python confusion_matrix_bcsa.py --dataset_name verbio --k 6 --y_dim 2 --n_bcsa 3
...
def f1_accuracy(network, loader, class_num, device):
    ...
    with torch.no_grad():
        for labels, ppg, scr, scl, eda in loader:
            labels, ppg, scl = Variable(labels).to(device), Variable(ppg).to(device), Variable(scl).to(device)
            p, _, _ = network(ppg, scl)
...
if __name__ == "__main__":
    ...
    for fold in range(args.k):
        ...
        if args.dataset_name == 'wesad':
            ...
            test_dataset = CAN_STRESS_dataset(test_subject[fold])
        elif args.dataset_name == 'verbio':
            test_dataset = VerBIO_dataset(test_subject[fold])
        ...
        acc, f1, recall, precision = f1_accuracy(model, test_loader, args.y_dim, device)
        print(
