# python draw_tsne_pre.py --dataset_name wesad --k 5 --y_dim 2
# python draw_tsne_pre.py --dataset_name wesad --k 5 --y_dim 3
# python draw_tsne_pre.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 2
# python draw_tsne_pre.py --dataset_name ubfc_phys --k 7 --y_dim 2 --ubfc_phys_task 3
# python draw_tsne_pre.py --dataset_name verbio --k 5 --y_dim 2
...
for fold in range(args.k):
    ...
    # plt.title(f'Without Using MMDG')
    plt.xticks([])  # 去除 x 轴刻度
    plt.yticks([])  # 去除 y 轴刻度
    ...
    # 保存图像
    save_path = os.path.join("tsne_plots", f'tsne_fold_{fold + 1}_PRE.png')
