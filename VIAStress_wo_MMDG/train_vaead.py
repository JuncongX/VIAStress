# nohup python -u train_vaead.py --y_dim 2 > VAEAD_2.out &
# nohup python -u train_vaead.py --y_dim 3 > VAEAD_3.out &
# nohup python -u train_vaead.py --dataset_name ubfc_phys --ubfc_phys_task 2 --y_dim 2 --k 7 > VAEAD_2_UP2.out &
# nohup python -u train_vaead.py --dataset_name ubfc_phys --ubfc_phys_task 3 --y_dim 2 --k 7 > VAEAD_2_UP3.out &
# nohup python -u train_vaead.py --dataset_name ubfc_phys --y_dim 3 --k 7 > VAEAD_3_UP.out &
import numpy as np
import os
...
from VIAStress_wo_MMDG.model import Model
from VIAStress_wo_MMDG.Loss import Loss
