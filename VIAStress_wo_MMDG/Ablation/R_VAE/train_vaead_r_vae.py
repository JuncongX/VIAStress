# nohup python -u train_vaead_r_vae.py --y_dim 2 > VAEAD_r_vae_2.out &
# nohup python -u train_vaead_r_vae.py --y_dim 3 > VAEAD_r_vae_3.out &
# nohup python -u train_vaead_r_vae.py --dataset_name ubfc_phys --ubfc_phys_task 2 --y_dim 2 --k 7 > VAEAD_r_vae_2_UP2.out &
# nohup python -u train_vaead_r_vae.py --dataset_name ubfc_phys --ubfc_phys_task 3 --y_dim 2 --k 7 > VAEAD_r_vae_2_UP3.out &
# nohup python -u train_vaead_r_vae.py --dataset_name ubfc_phys --y_dim 3 --k 7 > VAEAD_r_vae_3_UP.out &
import numpy as np
import os
...
from VIAStress_wo_MMDG.Ablation.R_VAE.R_VAE import Model, BVPEncoder, BVPDecoder, EDAEncoder, EDADecoder
...
if __name__ == '__main__':
    ...
    for fold in range(args.k):
        ...
        if args.pre_train:
            bvp_encoder = BVPEncoder(r_dim=args.r_dim, x_dim=args.x_dim)
            ...
            eda_encoder = EDAEncoder(r_dim=args.r_dim, x_dim=args.x_dim)
        ...
        optimizer = torch.optim.Adam([
            ...
            {'params': model.feature_fc.parameters(), 'lr': 1e-3},
        ...
        for epoch in range(args.epoch):
            ...
            if epoch_valid_f1 >= bestf1_ever:
                ...
                torch.save(model.state_dict(), os.path.join(args.save_path,
                                                                   'VAEAD_r_vae_{0}_{1}_{2}{3}.pth'.format(
                                                                       args.dataset_name,
                                                                       args.y_dim,
                                                                       model_name_tool(args),
                                                                       fold + 1)))
