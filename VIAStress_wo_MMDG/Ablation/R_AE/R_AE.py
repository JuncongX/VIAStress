...
from VIAStress_wo_MMDG.model_pre import FeatureEmbed, ADClassifier, BVPDecoder, EDADecoder
...
class Model(nn.Module):
    def __init__(self, x_dim, r_dim, h_dim, y_dim, bvp_encoder_ae=None, bvp_decoder_ae=None, eda_encoder_ae=None,
        ...
        self.bvp_encoder_vae = BVPEncoder(x_dim, r_dim) if bvp_encoder_ae is None else bvp_encoder_ae
        self.bvp_decoder_vae = BVPDecoder(r_dim) if bvp_decoder_ae is None else bvp_decoder_ae
        self.eda_encoder_vae = EDAEncoder(x_dim, r_dim) if eda_encoder_ae is None else eda_encoder_ae
    ...
    def forward(self, bvp, eda):
        ...
        return out, recon_bvp, recon_eda